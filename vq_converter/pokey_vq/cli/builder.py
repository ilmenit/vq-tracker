...
class PokeyVQBuilder:
    ...
    def assemble(self):
        ...
        try:
            ...
            # Copy intermediate ASM artifacts to output folder
            ...
            # Also copy the main player asm
            artifacts.append(player_asm_name)

            for f_name in artifacts:
                src_artifact = os.path.join(build_cwd, f_name)
