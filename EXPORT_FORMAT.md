...
- `note & $3F = 1-48` - Actual notes (C-1=1 through B-4=48)

**Pitch Table Mapping:**
When playing, the ASM code converts notes 1-48 to pitch table indices 0-47:
